...
por cada respuesta correcta de la tabla )
    ...
    escritas en cierto lenguaje de programación
    ...
    durante su tiempo de ejecución, es decir,                      Lenguaje de programación
    ...
    hacer. tiene ciertas reglas de escritura                            Programa
...
1. Menciona al menos 3 tipos de datos que existen: (valor 0.4)
    ...
    Respuesta: Constantes, Variables y Correctas
...
2. ¿Qué tipo es cada uno de los siguientes datos? (valor 0.4 por cada inciso)
        ...
        c) El mensaje ‘Esto es dato entero’                                            Variable

        d) 35 >= 12                                                                    Constante

        e) 3*3                                                                         Constante

        f) La edad de una persona                                                       Variable

        g) El pago por un servicio o producto                                           Variable

        h) El símbolo ‘@’                                                              Constante

        i) El mensaje ‘Agrega más artículos a tu canasta para envío GRATIS’             Variable
...
Resuelve el siguiente CAPTCHA: 3 > 4 ¿Cierto o Falso?       Respuesta Cierto

(v alor 0.4 por cada respuesta en fila correcta)    

Llena la siguiente tabla:

    Requerimiento                                               Tipo de dato

    Nombre Completo:                                               Variable
    
    Peso en kilogramos:                                           Constante
...
Indica que tipo de variable es en cada caso: (valor 0.3 por cada uno)
    ...
    14. interrup = true                         Variable

    15. apellido= ‘lopez’                       Variable

    16. x = x + 1                              Constante

    17. suma = suma + num                       Variable

    18. c = sqrt(a*a + b*b)                    Constante
